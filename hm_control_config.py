...
hm_control_cfg_fail_power_limit = hm_control_cfg_inverter_power_min # power that should be generated if energy consumption cannot be retrieved more than "hm_control_cfg_fail_threshold" from Shelly 3EM; set to desired value or to "0" if you want to turn off inverter
