...
hm_control_cfg_power_threshold_in = 10 # the value which needs to be exceeded before setting a new power limit, when receiving from the grid (should be >= 0)
hm_control_cfg_power_threshold_out = -5 # the value which needs to be exceeded before setting a new power limit, when feeding into the grid (should be <= 0)
