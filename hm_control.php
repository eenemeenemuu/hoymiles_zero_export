...
if ($hm_control_config_override['override_valid_until'] > time()) {
    ...
    $power_off_button_add_time = "document.getElementById('override_valid_until_h').value=1;";
}

$power_off_button = '<input type="button" name="power_off" value="Power OFF" onclick="document.getElementById(\'inverter_power_max\').value=-999999;'.$power_off_button_add_time.'document.getElementById(\'save\').click();" />';
...
echo '<tr><td>override_valid_until</td><td>N/A</td><td>'.date("d.m.Y H:i:s", $hm_control_config_override['override_valid_until']).'</td><td align="right">Days: <input type="text" size="2" name="override_valid_until_d" value="'.$hm_control_config_override['override_valid_until_d'].'" /><br />Hours: <input type="text" size="2" name="override_valid_until_h" id="override_valid_until_h" value="'.$hm_control_config_override['override_valid_until_h'].'" /><br />Minutes: <input type="text" size="2" name="override_valid_until_m" value="'.$hm_control_config_override['override_valid_until_m'].'" /><br />Seconds: <input type="text" size="2" name="override_valid_until_s" value="'.$hm_control_config_override['override_valid_until_s'].'" /></td></tr>';
echo '<tr><td>inverter_power_min</td><td>'.$hm_control_config['inverter_power_min'].'</td><td>'.$hm_control_config_override['inverter_power_min'].'</td><td align="right"><input type="text" size="2" name="inverter_power_min" id="inverter_power_min" value="'.$hm_control_config_override['inverter_power_min'].'" /></td></tr>';
echo '<tr><td>inverter_power_max</td><td>'.$hm_control_config['inverter_power_max'].'</td><td>'.$hm_control_config_override['inverter_power_max'].'</td><td align="right"><input type="text" size="2" name="inverter_power_max" id="inverter_power_max" value="'.$hm_control_config_override['inverter_power_max'].'" /></td></tr>';
echo '<tr><td>power_target</td><td>'.$hm_control_config['power_target'].'</td><td>'.$hm_control_config_override['power_target'].'</td><td align="right"><input type="text" size="2" name="power_target" id="power_target" value="'.$hm_control_config_override['power_target'].'" /></td></tr>';
echo '<tr><td>power_target_lower_threshold</td><td>'.$hm_control_config['power_target_lower_threshold'].'</td><td>'.$hm_control_config_override['power_target_lower_threshold'].'</td><td align="right"><input type="text" size="2" name="power_target_lower_threshold" id="power_target_lower_threshold" value="'.$hm_control_config_override['power_target_lower_threshold'].'" /></td></tr>';
echo '<tr><td>power_target_upper_threshold</td><td>'.$hm_control_config['power_target_upper_threshold'].'</td><td>'.$hm_control_config_override['power_target_upper_threshold'].'</td><td align="right"><input type="text" size="2" name="power_target_upper_threshold" id="power_target_upper_threshold" value="'.$hm_control_config_override['power_target_upper_threshold'].'" /></td></tr>';
echo '<tr><td colspan="4" align="right"><input type="range" min="-'.round($hm_control_config['inverter_power_max']/2).'" max="'.round($hm_control_config['inverter_power_max']/2).'" value="'.(isset($hm_control_config_override['power_target']) ? $hm_control_config_override['power_target'] : $hm_control_config['power_target']).'" '.$slider_js.' style="width:100%;" /></td></tr>';
echo '<tr><td colspan="4" align="right">'.$power_off_button.' <input type="button" name="delete" onclick="window.location=\'?delete\'" value="Delete values" /> <input type="submit" name="save" id="save" value="Save values" /></td></tr>';
